...
#help
echo "help"
cat /home/salma/Bureau/projetscripting/help.txt
...
echo "v1.0"
echo "-------------------"
echo "by Gannouni Salma & Fhima Yahya"
}
...
show_usage()
{
echo "statistic :[-h|--help] [-T] [-t] [-n] [-N] [-d] [-m] [-s] chemin.."
}
...
while : 
do
yad --title='MENU' --text="choisir une option" \
--button='afficher taille totale occupée':1 \
--button='afficher taille occupée par les fichiers/repertoires':2 \
--button='afficher nbre de fichier non vide':3 \
--button='afficher nbre de fichier vide':4 \
--button='afficher nbre de fichier python,html,txt,..':5 \
--button='afficher help':6 \
--button='afficher nom des auteurs et version du code':7 \
--button='afficher nbre de petit fichiers et gros fichiers':8 \
--button='Menu textuelle':9 \
--button='quitter':10
retour=$?
case $retour in 
1) 
